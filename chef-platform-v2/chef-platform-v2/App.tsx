...
const mockChefs = [
  {
    ...
    reviewCount: 23,
    image:
      "https://images.unsplash.com/photo-1622001635931-3874528bd099?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBjaGVmJTIwY29va2luZyUyMGdvdXJtZXQlMjBmb29kfGVufDF8fHx8MTc1ODQxMzU1Mnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  },
  {
    ...
    reviewCount: 31,
    image:
      "https://images.unsplash.com/photo-1719329466199-f18fb7f6972e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjaGVmJTIwcG9ydHJhaXQlMjBjb29raW5nJTIwa2l0Y2hlbnxlbnwxfHx8fDE3NTg0MTM2MjZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  },
  {
    ...
    reviewCount: 18,
    image:
      "https://images.unsplash.com/photo-1718939043990-83078968ae7e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmaW5lJTIwZGluaW5nJTIwcGxhdGVkJTIwZm9vZCUyMGVsZWdhbnR8ZW58MXx8fHwxNzU4NDEzNjI5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
...
export default function App() {
  ...
  const [isChefSignupOpen, setIsChefSignupOpen] =
    useState(false);
            ...
            {!currentUser && (
              <div className="mb-12 sm:mb-16 text-center">
                <div className="mb-6 sm:mb-8">
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl mb-2 relative inline-flex items-center justify-center">
                    <span className="relative z-10">Tabl</span>
                    <span className="relative z-10">e</span>
                    <ArtisticAmpersand
                      className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 absolute opacity-40 animate-pulse"
                      style={{ zIndex: 5 }}
                    />
                ...
                <div className="relative inline-block">
                  ...
                  <Button
                    ...
                    className="relative z-10 rounded-2xl bg-white text-black hover:bg-white/90 px-6 sm:px-8 py-3 text-base sm:text-lg overflow-hidden"
                  >
